...
export default function BookingDetailPage() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <Link to="/account/bookings" className="text-sm text-slate-500 hover:underline">
          &larr; My bookings
        </Link>
        ...
        <p className="mt-1 text-sm text-slate-600">{BOOKING_STATUS_HELP[booking.status]}</p>
      </div>
      ...
      <section className="flex gap-4 rounded-lg border border-slate-200 bg-white p-5">
        <div className="h-24 w-32 shrink-0 overflow-hidden rounded bg-slate-100">
        ...
        <div>
          <h2 className="font-semibold text-slate-900">{booking.vehicle.name}</h2>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-5">
        <h2 className="font-semibold text-slate-900">Rental period</h2>
